...
| [Packed Lenses: Matrices, Integers, and Views](./packed-lenses-matrix-bignum-and-views.md) | Affine layouts, packed algebra, shared strided packing, view folds, the narrowed bit-sliced proposal, expansion, and Flight integration. |
