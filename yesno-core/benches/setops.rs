...
/// keeping for it: `array/generic` is the **counterfactual** — what array×array
/// cost before it had an arm, and therefore what the arm is worth —
...
/// Do not read `array/generic` as current behaviour, and do not delete it:
/// a measured before is the only thing that keeps "flat 2.5x, m = 32 to 4096"
/// falsifiable.
///
